    ...
    <section className="w-full relative py-16 px-4">
      <div className="max-w-7xl mx-auto">
        ...
        <header className="flex flex-col items-center mb-16 translate-y-[-1rem] animate-fade-in opacity-0">
          ...
          <h2 className="text-5xl font-medium text-center tracking-[-1.44px] leading-[58px] [font-family:'Poppins',Helvetica] max-w-md">
            <span className="text-black tracking-[-0.69px]">About the </span>
            <span className="text-[#0aa26c] tracking-[-0.69px]">Founders</span>
          </h2>

          <p className="mt-4 text-lg text-neutral-700 text-center max-w-lg leading-[26px] [font-family:'Inter_Variable-Regular',Helvetica]">
            An AI-native platform that drives portfolio efficiency.An AI-native
            platform that drives portfolio efficiency.
          </p>
        </header>
